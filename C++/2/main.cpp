...
Node* Student_ConcatTestRopeLeft();
Node* Student_ConcatTestRopeRight();
...
void StudentTests(){
	...
	Rope r1(Student_ConcatTestRopeLeft());
	Rope r2(Student_ConcatTestRopeRight());
	std::string s1 = "Below is ";
	std::string s2 = "stud t";
	assert(SAME(r1,s1));
	assert(SAME(r2,s2));
	std::cout << "***Student Index test passed." << std::endl;


	Rope r3(IndexTestRope());
	std::string s3 = "Hello my name is Qifan Jiang";
	Rope r4;
	std::string s4 = s3.substr(0,12);
	r3.split(12,r4);
	assert(SAME(r3,s4));
	std::cout << "***Student Split test 1 passed." << std::endl;

	Rope r5(IndexTestRope());
	std::string s5 = "Hello my name is Qifan Jiang";
	Rope r6;
	std::string s6 = s5.substr(0,14);
	r5.split(14,r6);
	assert(SAME(r5,s6));
	std::cout << "***Student Split test 2 passed." << std::endl;
