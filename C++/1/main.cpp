...
int main(int argc, char* argv[]) {
  ...
  // ./richochet_robots <puzzle_file> -visualize <which_robot>
  // ./richochet_robots <puzzle_file> -max_moves <#> -visualize <which_robot>
  if(visualize != ' ') // visualize a robot
  {
	  board.visualize(visualize, max_moves);
	  return 0;
  }

  // ./richochet_robots <puzzle_file> -all_solutions
  // ./richochet_robots <puzzle_file> -max_moves <#> -all_solutions
  if(all_solutions) { // find all solutions
	  board.findAllSolutions(max_moves);
	  return 0;
  }

  // find one arbitory solution
  // ./richochet_robots <puzzle_file> -max_moves <#>
  if(max_moves > 0) {
	  board.findArbitorySolution(max_moves);
	  return 0;
  }

  // for now...  an example of how to use the board print function
  // ./richochet_robots <puzzle_file>
  board.print();
  return 0;
}
